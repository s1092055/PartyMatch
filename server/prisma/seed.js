...
const SERVICES = [
  ...
  { id: 'netflix',          name: 'Netflix',        category: '影音', plans: [{ id: 'netflix-std', name: '標準', maxMembers: 2, monthlyFee: 380, currency: 'TWD' }, { id: 'netflix-4k', name: '高級（4K）', maxMembers: 4, monthlyFee: 460, currency: 'TWD' }] },
  ...
  { id: 'friday-video',     name: 'friDay影音',       category: '影音', plans: [{ id: 'friday-video-plan', name: '影劇暢看方案', maxMembers: 2, monthlyFee: 199, currency: 'TWD' }] },
  ...
  { id: 'kkbox',            name: 'KKBOX',          category: '音樂', plans: [{ id: 'kkbox-3', name: '3人家庭方案', maxMembers: 3, monthlyFee: 229, currency: 'TWD' }, { id: 'kkbox-6', name: '6人家庭方案', maxMembers: 6, monthlyFee: 260, currency: 'TWD' }] },
  ...
  { id: 'duolingo',         name: 'Duolingo',       category: '學習', plans: [{ id: 'duolingo-family', name: 'Family', maxMembers: 6, monthlyFee: 199, currency: 'TWD' }] },
  { id: 'masterclass',      name: 'MasterClass',    category: '學習', plans: [{ id: 'masterclass-2', name: '家庭方案（2人）', maxMembers: 2, monthlyFee: 480, currency: 'TWD' }, { id: 'masterclass-6', name: '家庭方案（6人）', maxMembers: 6, monthlyFee: 640, currency: 'TWD' }] },
  ...
  { id: 'nordvpn',          name: 'NordVPN',        category: 'VPN', plans: [{ id: 'nordvpn-basic', name: 'Standard', maxMembers: 6, monthlyFee: 375, currency: 'TWD' }, { id: 'nordvpn-plus', name: 'Plus', maxMembers: 6, monthlyFee: 487, currency: 'TWD' }, { id: 'nordvpn-ultimate', name: 'Complete', maxMembers: 6, monthlyFee: 650, currency: 'TWD' }] },
  ...
  { id: 'apple-one',        name: 'Apple One',      category: '套組', plans: [{ id: 'apple-one-individual', name: '個人方案', maxMembers: 1, monthlyFee: 390, currency: 'TWD' }, { id: 'apple-one-family', name: '家庭方案', maxMembers: 6, monthlyFee: 490, currency: 'TWD' }] },
]
