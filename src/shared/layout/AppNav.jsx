  ...
  return (
    <>
      ...
      <div className="fixed top-6 z-50 hidden flex-col items-center gap-2 md:flex lg:top-8" style={{ right: 'calc(1.5rem + var(--scrollbar-compensation, 0px))' }}>
        ...
        <button
          onClick={openNotify}
          className="relative grid h-12 w-12 place-items-center rounded-full border border-white/40 bg-slate-100/70 text-ink-2 shadow-md backdrop-blur-md transition-all hover:scale-105 hover:bg-slate-100/90 hover:text-ink active:scale-95"
          aria-label="通知"
        >
