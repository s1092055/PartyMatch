          ...
          {myMenuOpen && loggedIn && (
            <div className="absolute bottom-full mb-2 left-1/2 -translate-x-1/2 z-50 flex flex-row gap-1 rounded-2xl border border-line bg-white p-1.5 shadow-popover">
              <a
                ...
                className={`flex flex-col items-center gap-1.5 rounded-xl px-4 py-2.5 text-xs font-bold whitespace-nowrap transition-colors hover:bg-raised ${pathname === '/my-subscriptions' ? 'text-brand' : 'text-ink'}`}
              >
              ...
              <a
                href="/manage-groups"
                onClick={() => setMyMenuOpen(false)}
                className={`flex flex-col items-center gap-1.5 rounded-xl px-4 py-2.5 text-xs font-bold whitespace-nowrap transition-colors hover:bg-raised ${pathname === '/manage-groups' ? 'text-brand' : 'text-ink'}`}
              >
