const BASE = 'inline-flex items-center justify-center gap-2 font-bold rounded-inner transition-all focus:outline-none focus:ring-2 focus:ring-offset-1 disabled:opacity-50 disabled:pointer-events-none'
