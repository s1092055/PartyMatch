    ...
    plans: [
      ...
      },
      {
        ...
        features: [
          ...
          'Gemini Advanced 存取（含 Gemini Omni 模型）',
          'Google Workspace AI 功能（Gmail、Docs、Slides 輔助）',
          'NotebookLM Plus',
          'VPN by Google One',
        ],
      },
    ...
    plans: [
      {
        ...
        features: [
          ...
          '無限檔案上傳，支援 PDF、CSV 等文件分析',
          'AI 圖像生成功能（DALL-E、SDXL）',
          '每月 $5 API 點數，可使用 Perplexity API',
          '搜尋結果含完整來源引用',
          '優先處理速度，比免費版更快回應',
        ],
      },
