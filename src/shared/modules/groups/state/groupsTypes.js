export const GROUPS_ACTIONS = {
  ...
  APPLY_GROUP: "GROUPS/APPLY_GROUP",
  CANCEL_APPLICATION: "GROUPS/CANCEL_APPLICATION",
  APPROVE_APPLICATION: "GROUPS/APPROVE_APPLICATION",
  REJECT_APPLICATION: "GROUPS/REJECT_APPLICATION",
  REMOVE_MEMBER: "GROUPS/REMOVE_MEMBER",
  DISSOLVE_GROUP: "GROUPS/DISSOLVE_GROUP",
...
export const GROUPS_STORE_SCHEMA_VERSION = 5;
