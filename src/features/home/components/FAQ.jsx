...
const FAQS = [
  ...
  {
    q: '加入群組後如何完成付款？',
    a: '申請通過、團主啟用群組後，你會收到通知。請前往「我的訂閱」填寫你在該服務使用的電子信箱（服務帳號），再依照群組聊天室中團主提供的收款資訊（匯款帳號等）完成付款並上傳截圖。團主確認收款後，訂閱正式啟用。',
  },
  {
    q: '帳號安全嗎？我的個人資料會外洩嗎？',
  ...
  {
    q: '如何成為團主？',
    a: '登入後點擊「建立群組」，經過 4 個步驟（選服務、選方案、設定名額與規則、確認送出）即可上架群組開始招募。名額全數核准後，填寫收款帳號並啟用群組，系統會引導你完成收款確認與服務啟用流程。',
  },
  {
    q: '群組啟用後我還需要做什麼？',
