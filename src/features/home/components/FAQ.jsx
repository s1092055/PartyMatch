...
const FAQS = [
  ...
  {
    q: '群組鎖定後我還需要做什麼？',
    a: '全員席位費用於接受申請當下即已完成代管，鎖定群組後僅須等待成員填寫服務帳號。全員填寫完成後，系統將顯示「啟用服務」按鈕，點擊後群組進入 48 小時確認期；期間若無成員申訴，代管款項將自動撥付予您。',
  },
  {
    q: '如果成員覺得服務有問題怎麼辦？',
    a: '服務啟用後的 48 小時確認期內，成員可於群組聊天室反應問題，或向平台提出正式申訴。一旦提出申訴，該筆代管款項將被凍結，平台客服將於 3 天內完成裁定：若成員勝訴則退款並離開群組，若團主勝訴則款項撥付予團主，其餘成員權益不受影響。',
  },
]
