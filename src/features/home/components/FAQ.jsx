...
const FAQS = [
  ...
  {
    q: '如何成為團主？',
    a: '登入後點擊「建立群組」，經過 4 個步驟（選服務、選方案、設定名額與規則、確認送出）即可上架群組開始招募。名額全數接受後即可點擊「鎖定群組」——每位成員的席位費用其實已在你接受申請當下自動代管完成，系統會建立群組聊天室，接著引導你完成服務帳號確認與啟用流程。',
  },
  {
    q: '群組鎖定後我還需要做什麼？',
    a: '全員的席位費用在接受當下就已經代管完成，鎖定群組後只需等待成員填寫服務帳號。全員填寫完成後，系統會出現「啟用服務」按鈕，點擊後群組進入 48 小時確認期，期間沒有成員申訴的話，代管款項就會自動撥給你。',
  },
  {
    q: '如果成員覺得服務有問題怎麼辦？',
