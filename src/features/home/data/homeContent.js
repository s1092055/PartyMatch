...
export const HOW_IT_WORKS_STEPS = [
  ...
  },
  {
    step: 3,
    title: '送出加入申請',
    desc: '找到喜歡的群組就送出申請，附上留言讓團主了解你。等待團主審核，通過後會收到通知。',
    videoUrl: null,
  },
  {
    step: 4,
    title: '填寫服務帳號並完成付款',
    desc: '申請通過、群組啟用後，填寫你在該服務使用的電子信箱，再依照團主提供的收款資訊完成付款並上傳截圖。',
    videoUrl: null,
  },
  {
    step: 5,
    title: '等待團主確認收款',
    desc: '團主確認收到你的款項後，訂閱正式啟用。在「我的訂閱」可查看付款狀態與下次扣款日。',
    videoUrl: null,
  },
  {
    step: 6,
    title: '服務啟用，開始享用',
    desc: '服務啟用後收到通知，直接使用訂閱服務。如有問題可透過群組聊天室或私訊直接聯絡團主。',
    videoUrl: null,
  },
]

export const HOST_FLOW_STEPS = [
  {
    step: 1,
    label: '收到申請通知',
    desc: '系統會在通知中心提醒你有新的加入申請，點擊可直接跳到群組管理頁面查看。',
  },
  {
    step: 2,
    label: '審核申請',
    desc: '在「群組管理」查看申請者的信用分數與留言，決定核准或拒絕。核准後成員加入群組，名額自動減少並通知對方；拒絕則系統通知申請者，不影響其他成員。',
  },
  {
    step: 3,
    label: '名額招滿，啟用群組',
    desc: '名額全部核准後，點擊「啟用群組」並填寫你的收款帳號（例如匯款資訊）。確認後系統自動建立群組聊天室，並通知所有成員填寫服務帳號與完成付款。',
  },
  {
    step: 4,
    label: '逐筆確認成員付款',
    desc: '成員標記付款並上傳截圖後，前往「群組管理 → 收款紀錄」逐筆確認。確認即完成這筆紀錄；若有問題可回報付款失敗，通知成員重新補件。',
  },
  {
    step: 5,
    label: '全員確認，啟用服務',
    desc: '所有成員付款確認完成後，啟用按鈕自動出現。點擊「啟用服務」後群組進入 active 狀態，系統通知所有成員服務已正式啟用。到期後可選擇開始新一期收款或結束群組。',
  },
]
...
export const HOST_TASKS = [
  ...
  },
  {
    icon: CheckCircle2,
    title: '啟用群組',
    desc: '名額招滿後點擊「啟用群組」，填寫收款帳號後確認。系統自動建立群組聊天室，通知所有成員進行付款。',
  },
  {
    icon: Clock,
    title: '續訂或結束',
...
export const HOST_GUIDE_TABS = [
  { value: 'flow',   label: '申請流程', slides: HOST_FLOW_STEPS },
  { value: 'tasks',  label: '日常任務', slides: HOST_TASKS },
  { value: 'notice', label: '注意事項', slides: HOST_NOTICES },
]
