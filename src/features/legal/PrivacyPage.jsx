...
const SECTIONS = [
  ...
  {
    title: '三、資料揭露對象',
    body: '本平台不出售、租借或提供個人資料予任何第三方廣告商。您上傳的圖片與附件檔案，會透過雲端物件儲存服務商（Cloudflare R2）代為儲存，僅本平台可存取，且對外一律以短效期的簽章網址提供讀取。在以下情況下，本平台可能分享必要資訊：依法律規定或政府機關要求；為保護本平台、用戶或公眾的安全；在取得您明確同意的前提下。',
  },
  {
    title: '四、資料儲存與安全',
    body: '個人資料儲存於本平台自營的資料庫伺服器，採業界標準加密保護；其中團主提供的共用帳號密碼等高敏感資訊，於資料庫內另採 AES-256-GCM 加密儲存。本平台採取合理的技術措施防止資料外洩，但無法保證絕對安全。如發生資料安全事件，本平台將依法規要求通知受影響的用戶。',
  },
  {
    title: '五、用戶權利',
