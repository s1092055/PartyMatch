...
const SECTIONS = [
  ...
  {
    title: '四、PM 幣代管與交易安全',
    body: '用戶申請加入群組經團主接受後，系統將自動從用戶的 PM 幣餘額扣除席位費用並轉入平台代管；服務啟用並經過確認期無爭議後，代管款項將撥入團主的 PM 幣餘額。PM 幣儲值與提領規則另見平台公告。本平台僅就代管款項的收付提供技術服務，對用戶間因訂閱服務本身品質、帳號共享方式所生之糾紛不承擔責任，用戶應謹慎選擇信任的共享夥伴。',
  },
  {
    title: '五、智慧財產權',
