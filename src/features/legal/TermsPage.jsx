...
const SECTIONS = [
  ...
  {
    title: '四、PM 幣代管與交易安全',
    body: '用戶申請加入群組經團主接受後，系統將自動從用戶的 PM 幣餘額扣除席位費用並轉入平台代管；服務啟用並經過確認期無爭議後，代管款項將撥入團主的 PM 幣餘額。PM 幣儲值與提領規則另見平台公告。若用戶在確認期內回報服務資訊有誤或雙方發生爭議，本平台將審核相關佐證後做出二擇一之裁定：認定成員一方有理者，全額退款予成員；認定團主一方有理者，代管款項全額撥付予團主，不提供部分退款。本平台僅就代管款項的收付提供技術服務，對用戶間因訂閱服務本身品質、帳號共享方式所生之糾紛不承擔責任，用戶應謹慎選擇信任的共享夥伴。',
  },
  {
    title: '五、智慧財產權',
