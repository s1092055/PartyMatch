...
const ITEMS = [
  ...
  {
    title: 'PM 幣代管與帳號安全',
    body: '席位費用經由 PM 幣代管機制自動轉帳，用戶無需自行匯款或上傳付款截圖；若對代管款項的撥付有爭議，可於確認期內向平台回報問題，由客服裁定。PM 幣代管僅處理群組席位費用，本平台強烈建議用戶勿將訂閱服務本身的帳號主密碼分享予他人，並在適當時機更換密碼；任何因用戶自行分享帳號資訊所造成的損失，本平台不承擔責任。',
  },
  {
    title: '資料使用聲明',
