...
const ITEMS = [
  {
    title: '平台性質聲明',
    body: 'PartyMatch 提供共享訂閱夥伴的媒合功能，並透過平台內部虛擬貨幣「PM 幣」（1 PM 幣 = 新台幣 1 元）代管群組成員的席位費用：申請核准當下即自動從 PM 幣餘額轉入平台代管，待服務啟用並經過確認期後撥款予團主。本平台僅提供代管與撥款的技術服務，不代為購買、管理或提供任何第三方訂閱服務本身。',
  },
  {
    title: '使用條款責任',
