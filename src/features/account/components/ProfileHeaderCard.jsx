...
function HeroStatTile({ icon: Icon, iconClassName, label, onClick }) {
  return (
    <button
      onClick={onClick}
      className="flex flex-1 flex-col items-center justify-center gap-1.5 rounded-xl border border-line-subtle py-3 transition-colors hover:bg-raised md:w-24 md:flex-none"
    >
