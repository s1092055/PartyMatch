      ...
      <div className="flex items-start gap-4 mb-5">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 flex-wrap">
            <h1 className="text-2xl font-extrabold text-ink">{group.serviceName}</h1>
          ...
          <div className="flex items-center gap-2 mt-2">
            <div
              ...
              style={{ backgroundColor: group.hostAvatarColor }}
            >
              {group.hostAvatarInitial}
            </div>
            <span className="text-sm text-ink-2">{group.hostName}</span>
            <div className="flex items-center gap-0.5">
              <Star size={12} className="text-amber-400 fill-amber-400" />
              <span className="text-sm font-medium text-ink-2">{group.hostRating}</span>
