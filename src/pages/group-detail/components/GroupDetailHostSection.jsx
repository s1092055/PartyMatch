  ...
  return (
    <GroupDetailSection eyebrow="團主簡介" headingClassName="">
      <div className="mt-[-0.5rem] flex items-start gap-4">
        <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-full bg-black/[0.06] text-lg font-semibold text-black">
          {hostName.slice(0, 1)}
        </div>
      ...
      <div className="mt-8 space-y-6">
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2">
            {hostSignals.length ? (
              hostSignals.map((item, index) => (
                <li
                  key={`host-signal-${index}-${item}`}
