          ...
          >
            <div className="space-y-5 px-4 pb-3 pt-5 sm:px-5">
              <div className="rounded-[24px] bg-black/[0.025] p-4">
                ...
                />
                <div className={["mt-3 text-sm leading-7", remainingStatusTheme.subtleTextClassName].join(" ")}>
        ...
        <div className="grid grid-cols-2 gap-3">
          {isOwner ? (
            <button
              ...
              className="inline-flex min-w-0 items-center justify-center rounded-full border border-red-200 bg-red-50 px-4 py-3 text-sm font-semibold text-red-600 transition hover:border-red-300 hover:bg-red-100"
            >
