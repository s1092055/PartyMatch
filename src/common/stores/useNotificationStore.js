  ...
  startPolling: (userId) => {
    ...
    _stopPolling = startPolling(async (isActive) => {
      ...
      try {
        ...
        if (newNotifs.some(n => n.type === 'member_removed' || n.type === 'member_left' || n.type === 'group_cancelled' || n.type === 'application_approved' || n.type === 'all_service_info_filled' || n.type === 'billing_date_confirmed' || n.type === 'billing_date_adjusted' || n.type === 'group_full_member')) {
