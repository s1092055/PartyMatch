...
export default function ScrollToTop() {
  ...
  return (
    <button
      ...
      className="fixed right-6 bottom-[max(6.5rem,calc(env(safe-area-inset-bottom)+5.5rem))] z-40 hidden h-12 w-12 place-items-center rounded-full bg-surface border border-line text-ink-2 shadow-md transition-all hover:-translate-y-0.5 hover:bg-brand hover:text-white sm:grid can-hover:lg:bottom-24"
      aria-label="回到頂部"
    >
