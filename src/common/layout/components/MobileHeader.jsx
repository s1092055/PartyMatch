...
function HeaderIconButton({ onClick, label, icon: Icon, count }) {
  return (
    <button
      onClick={onClick}
      aria-label={label}
      className="relative grid h-14 w-14 shrink-0 place-items-center rounded-full border border-line bg-surface text-ink-2 shadow-sm transition-all hover:-translate-y-0.5 hover:bg-raised hover:text-ink"
    >
