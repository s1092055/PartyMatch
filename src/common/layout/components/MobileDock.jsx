import { Clipboard, Compass, Heart, LayoutDashboard, LayoutGrid, MessageSquare, PlusCircle, Search } from 'lucide-react'
    ...
    >
      <div className="flex h-16 items-stretch">
        ...
        <div ref={myMenuRef} className="relative flex flex-1 flex-col items-center justify-center">
          ...
          {myMenuOpen && loggedIn && (
            <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 z-50 flex flex-row gap-0 rounded-2xl border border-line bg-surface p-1.5 shadow-popover">
              <a
                href="/manage-groups"
        ...
        {loggedIn ? (
          ...
          >
            <MessageSquare size={22} strokeWidth={2.1} />
            訊息
            <LockBadge className="right-4 top-1.5" />
          </button>
        )}
