...
**前置條件**：demo1 主揪 G8（Google One，`active`）。
...
**前置條件**：demo1 主揪 G8（Google One，`active`），3 位成員PM幣餘額皆充足。
...
**前置條件**：demo1 主揪的任一非招募中群組（例如 G8 Google One）。
